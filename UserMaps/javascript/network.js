...
var data_Vue = new Vue({
	...
	data: {
		...
		phenotyping_class : [{'Name': 'Default PhenoC', 'Cost of phenotyping': 0}],
		show_warnings: false,
		warnings: [],
		runned: false,
		genetic_data:'Ens',
	...
	watch: {
		...
		traitsinfo: function(val){
			...
			if (diff > 0){
				...
				this.phenotyping_class = [{Name: "Default PhenoC", 'Cost of phenotyping': 0}];
...
function deleteProject() {
	...
	if(data_Vue.database.filter(x => x == name).length > 0){
